...
public:
    ...
    {
        BlurFilterDialog->setWindowTitle(QApplication::translate("BlurFilterDialog", "Dialog", nullptr));
        lbl_k_size_label->setText(QApplication::translate("BlurFilterDialog", "K-Size (M, M):", nullptr));
    } // retranslateUi
